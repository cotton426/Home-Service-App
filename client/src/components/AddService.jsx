...
function AddService (){
  ...
  const validationSchema = Yup.object().shape({
    ...
    category: Yup.string()
      .oneOf(["generalService","kitchenService","bathroomService"])
  });
        ...
        <Form className="ml-5 flex flex-col justify-center">
            ...
            <div className="h-[450px] flex flex-col justify-start items-start mt-6 border-b-2 border-gray-300">
                ...
                <div className=" flex flex-row justify-center space-x-40">
                  ...
                  <Field className="input-default w-[450px] text-gray-950"
                    id="serviceName" 
                    name="serviceName"
                  />
                </div>
                ...
                <div className="flex flex-row justify-center space-x-40 text-gray-950 mt-10">
                  ...
                  <Field as="select" name="category" className="input-default w-[450px]" placeholder="เลือกหมวดหมู่">
                ...
                <div className=" flex flex-row justify-center space-x-40 mt-10 ">
                      ...
                      <div className="flex flex-col justify-center items-center text-center text-gray-500 border-2 border-dashed border-gray-300 rounded h-[150px] w-[450px] cursor-pointer ">
                        ...
                        />
                        <button className="btn-ghost font-normal ">อัพโหลดรูปภาพ</button>
                ...
                <span className=" text-gray-700 font-normal text-xs pl-[260px] mt-5 ">ขนาดภาพที่แนะนำ: 1440 x 225 PX</span>

            </div>
          

          <div className="mt-5">
            <h1 className="text-gray-700 text-base font-medium">รายการบริการย่อย</h1>
              ...
              {({ remove, push }) => (
                <div className="flex flex-col justify-start items-start mt-6 gap-5">
                  {values.subServiceList.map((item, index) => (
                      <div className="flex flex-row justify-center items-center gap-5 " key={index}>
                          <RxDragHandleDots2 className="text-gray-500 mt-4"/>
                        <div className="flex flex-col ">
                          <label htmlFor={`subServiceList.${index}.subServiceName`}>ชื่อรายการ</label>
                          <Field className="input-default w-72"
                        ...
                        <div className="flex flex-col">
                          <label htmlFor={`subServiceList.${index}.serviceCharge`}>ค่าบริการ / 1 หน่วย</label>
                          <Field className="input-default w-72"
                        ...
                        <div className="flex flex-col">
                          <label htmlFor={`subServiceList.${index}.serviceUnit`}>หน่วยการบริการ</label>
                          <Field className="input-default w-72"
